<h2><a href="https://www.geeksforgeeks.org/problems/find-number-of-numbers/1">Count Occurrence of digit k</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 14pt;">Given an array <strong>arr[]</strong>. Your task is to&nbsp;return an integer denoting<strong>&nbsp;</strong>the total number of times digit k appears in the array.</span></p>
